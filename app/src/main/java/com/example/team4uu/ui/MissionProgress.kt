...
// Serializable: MainScreen에서 rememberSaveable로 들고 있어서(화면 회전에도 별 진행도가
// 안 날아가게) List<MissionLevelProgress>가 Bundle에 담길 수 있어야 함.
data class MissionLevelProgress(val level: Int, val starsEarned: Int) : Serializable
